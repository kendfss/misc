...
def main(path, basic:bool=True, xml:bool=False, wordlist:bool=False, advanced:bool=False, low_level:bool=False):
    PDFNet.Initialize()
...
if __name__ == '__main__':
    ...
    path =  r"C:\Users\Kenneth\Downloads\pdf2image\PDFNetPython3samples\Samples\TestFiles\newsletter.pdf"
    # path =  "../../TestFiles/newsletter.pdf"
    main(path)
I N r HIS YEA R Eighteen Hundred and Ninety-eight, the Fourth
,I"y of June, at the request arM. and Mme. Bonhomme Oacques),
till' husband residing at Paris, rue Pavee, 37, electing domicile in my
"/1'"' ,nd further at the Town Hall of Q borough; I, the under-
IiHII,-ti, Rene-Isidore Panmuphle, BALIFF attached to the Civil Court
II/I/il'll blStance of the Department of the Seine, in session at Paris, resid-
IIIH //I sClid City, 37, rue Pavee, have signified) declared, and under the
./""',. heading deposited copy with M. Faustroll...