"""
https://stackoverflow.com/questions/64282844/num-must-be-1-num-6-not-7-in-python-for-k-means-clustering
"""
...
def InitCenter(k,m,x_train):
  ...
  Center = np. zeros ([k, n])
  np. random. seed (15) # Set random number seeds
  for i in range(k):
...
if __name__=="__main__":
  # x = pd. read_csv ("8. Advertising. csv")# Two groups of test data
